...
public class Levels {
    ...
    static {
        ...
        //L5
        LevelQuest l1_2_1_1_1_End = new LevelQuest("Старуха согласилась. Она провела рукой перед вашим лицом, и вы почувствовали, как ваша кожа становится упругой, а волосы — темными и густыми. Однако, став моложе, вы теперь обязаны служить старухе на протяжении столетия, превратившись в её вечного слугу.",null,null);
