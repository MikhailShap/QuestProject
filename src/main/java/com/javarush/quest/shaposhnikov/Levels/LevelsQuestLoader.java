...
public class LevelsQuestLoader {
    ...
    static {
        ...
        LevelQuest l2_2_2_End = new LevelQuest("Вы не стали бороться с проклятием, поэтому спустя две недели Вы отправились в мир иной.");
        //L4
        LevelQuest l1_1_1_1_End = new LevelQuest("Старуха согласилась. Она превратила Вас в золотую статую Теперь Вы навсегда останетесь украшением в доме старухи.");
        LevelQuest l1_1_1_2_End = new LevelQuest("Старуха рассмеялась и похвалила Вашу смекалку. Теперь Вы свободны.");
        ...
        LevelQuest l1_2_2_2_End = new LevelQuest("Вы отказались будить девушку. Старуха разозлилась и начала Вас проклинать. Вы пытались убежать, но проклятие Вас нагнало, и Вы превратились в пыльный ковер, лежащий у двери. Каждый, кто входит в дом, ступает на вас, оставляя следы своего прошлого.");
        ...
        LevelQuest l2_1_1_2_End = new LevelQuest("Вы отказались будить девушку. Старуха разозлилась и начала Вас проклинать. Вы пытались убежать, но проклятие Вас нагнало, и Вы превратились в ржавый светильник, который теперь освещает комнату старухи. Ваш свет мерцает и создает зловещую атмосферу в помещении.");
        ...
        LevelQuest l2_1_2_2_End = new LevelQuest("Вы отказались будить девушку. Старуха разозлилась и начала Вас проклинать. Вы пытались убежать, но проклятие Вас нагнало, и Вы превратились в старый письменный стол, на котором старуха пишет свои заклинания. Каждую ночь вы слышите шепот её слов, произносимых над вами.");
        LevelQuest l2_2_1_1_End = new LevelQuest("Вы согласились разбудить девушку. Старуха снимает с Вас проклятие, но не разрешает Вам уйти. Теперь Вы будете узником дома старухи.");
        LevelQuest l2_2_1_2_End = new LevelQuest("Старуха усмехается хитро: \"Ты принял решение, и теперь пожалуй, это будет последним твоим решением.\" Вы начинаете чувствовать, как ваши ноги превращаются в камень. Это проклятие продолжает распространяться, и вскоре вы полностью окаменеваете, став статуей в комнате старухи на вечность.");
        //L5
        LevelQuest l1_2_1_1_1_End = new LevelQuest("Старуха согласилась. Она провела рукой перед вашим лицом, и вы почувствовали, как ваша кожа становится упругой, а волосы — темными и густыми. Однако, став моложе, вы теперь обязаны служить старухе , превратившись в её вечного слугу.");
        LevelQuest l1_2_1_1_2_End = new LevelQuest("Старуха рассмеялась и похвалила Вашу смекалку. Теперь Вы свободны.");
        ...
        LevelQuest l1_2_2_1_2_End = new LevelQuest("Старуха рассмеялась и похвалила Вашу смекалку. Теперь Вы свободны.");
        LevelQuest l2_1_1_1_1_End = new LevelQuest("Старуха ухмыльнулась и выполнила ваше желание. Теперь вы действительно непобедимы. Однако теперь в так же стали стражем у входа в её дом, защищая его от посторонних на протяжении вечности.");
        LevelQuest l2_1_1_1_2_End = new LevelQuest("Старуха рассмеялась и похвалила Вашу смекалку. Теперь Вы свободны.");
